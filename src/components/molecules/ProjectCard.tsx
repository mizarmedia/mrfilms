    ...
    <>
      ...
      >
        <button
          ...
          className="w-full text-left group block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-lg"
        >
          <div className="relative overflow-hidden rounded-lg bg-slate aspect-video">
            ...
            {/* Overlay */}
            <div className="absolute inset-0 bg-void/30 group-hover:bg-void/20 transition-opacity duration-300" />
          ...
          {/* Info */}
          <div className="mt-4">
            <h3 className="text-xl font-display text-cream group-hover:text-amber-400 transition-colors duration-300">
              {project.title}
            </h3>
            {project.description && (
